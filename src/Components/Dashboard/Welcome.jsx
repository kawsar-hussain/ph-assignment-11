  ...
  return (
    <div className="relative mb-10 group ">
      ...
      <h1 className="text-4xl md:text-5xl font-black text-white italic tracking-tighter nova-square-regular">
        Hello, <span className="pr-3 text-transparent bg-clip-text bg-linear-to-r from-yellow-300 via-white to-yellow-500 drop-shadow-[0_0_15px_rgba(253,224,71,0.3)]">{dbUser.name}!</span>
