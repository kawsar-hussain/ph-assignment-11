...
const DonationRequests = () => {
  ...
  return (
    <div className="lg:px-20 pt-10 px-4 h-auto lg:min-h-[92vh]">
        ...
        <AnimatePresence mode="popLayout">
          {requests.map((request) => (
            <motion.div
              ...
              transition={{ duration: 0.3, delay: request._id * 0.1 }}
              whileHover={{ y: -5 }}
              className="group relative bg-black/30 backdrop-blur-xl rounded-3xl transition-all duration-500 hover:scale-[1.02] hover:-translate-y-2 active:scale-95 shadow-[0_0_20px_rgba(0,0,0,0.3)] hover:shadow-[0_20px_50px_rgba(220,73,0,0.3)] border border-white/10  hover:border-[#ff9215]/50 overflow-hidden"
            >
