    ...
    <div className="lg:px-20 pt-10 px-3 h-auto lg:min-h-[92vh]">
      ...
      <div className="">
        <div className="relative flex flex-col items-center mb-10 lg:mb-16 select-none">
          ...
          <h2 className="relative text-3xl lg:text-5xl font-black text-center uppercase italic tracking-tighter space-x-3">
          ...
          <div className="relative mt-4 lg:mt-6 flex items-center justify-center gap-3">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-start">
          <div className="flex-[20%]">
            <FilterAside setFilteredRequests={setFilteredRequests} setRequests={setRequests} requests={requests}></FilterAside>
          </div>
          <div className="flex-[80%] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-stretch">
            <AnimatePresence mode="popLayout">
              {[...filteredRequests].reverse().map((request) => (
                <div
                  key={request._id}
                  className=" group relative bg-black/30 backdrop-blur-xl rounded-3xl transition-all duration-500  hover:-translate-y-2 shadow-[0_0_20px_rgba(0,0,0,0.3)] hover:shadow-[0_20px_50px_rgba(220,73,0,0.3)] border border-white/10  hover:border-[#ff9215]/50 overflow-hidden"
                >
                  ...
                  <div className="relative  rounded-[1.4rem] p-4 lg:p-6 h-full flex flex-col justify-between z-10 border border-white/5">
                    <div className="flex justify-between items-start mb-8">
                      <div className="space-y-1">
                        <h2 className="text-xl lg:text-2xl font-black text-white italic tracking-tight group-hover:text-[#ffa41c] transition-colors">{request.recipientName}</h2>
            ...
            {filteredRequests.length === 0 && requests.length > 0 && (
              <div className="col-span-full text-center py-10">
                <p className="text-white text-xl font-semibold">No donation requests found matching your filters.</p>
              </div>
            )}
          </div>
        </div>
