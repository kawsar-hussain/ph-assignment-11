...
const Banner = () => {
  ...
  return (
    <div className="lg:px-20 py-10 px-5">
      <div className="bg-black/15 backdrop-blur-md rounded-md flex flex-wrap justify-center items-center gap-10 py-24 px-6">
        {!user && (
          <div className="relative group p-[3px] overflow-hidden rounded-xl transition-all duration-500 hover:scale-110 hover:-translate-y-2 active:scale-95 shadow-[0_0_20px_rgba(220,73,0,0.2)] hover:shadow-[0_20px_40px_rgba(220,73,0,0.5)]">
            ...
            <Link
              to="/register"
              className="relative w-full lg:w-[320px] h-[250px] flex flex-col justify-center bg-linear-to-tr from-[#dc4900] via-[#dc4900] to-[#ffa41c] text-white text-center rounded-lg py-8 z-10 transition-colors duration-500 overflow-hidden"
            >
              <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-500"></div>

              <IoMdPersonAdd className="m-auto text-8xl mb-4 group-hover:rotate-12 transition-transform duration-500" />
        ...
        <div className="relative group p-[3px] overflow-hidden rounded-xl transition-all duration-500 hover:scale-110 hover:-translate-y-2 active:scale-95 shadow-[0_0_20px_rgba(255,164,28,0.2)] hover:shadow-[0_20px_40px_rgba(255,164,28,0.5)]">
          ...
          <Link
            to="/search-donor"
            className="relative w-full lg:w-[320px] h-[250px] flex flex-col justify-center bg-linear-to-tl from-[#dc4900] via-[#dc4900] to-[#ffa41c] text-white text-center rounded-lg py-8 z-10 transition-colors duration-500 overflow-hidden"
          >
            <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-500"></div>
            <MdPersonSearch className="m-auto text-8xl mb-4 group-hover:-rotate-12 transition-transform duration-500" />
