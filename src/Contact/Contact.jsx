...
const Contact = () => {
  return (
    <div className="lg:px-20 pb-16 px-5 flex flex-col items-center">
      {/* 2. CLEAN CONTACT FORM */}
      <div className="max-w-2xl w-full">
        <div className="bg-black/15 backdrop-blur-sm border border-white/10 rounded-[2.5rem] overflow-hidden">
          <div className="p-8 md:p-12">
            <div className="relative flex items-center justify-center mb-10 group">
              ...
              <div className="relative h-24 w-24 flex items-center justify-center bg-linear-to-tr from-[#dc4900] to-[#ffa41c] rounded-full shadow-[0_0_40px_rgba(220,73,0,0.6)] animate-bounce [animation-duration:3s] z-10 border-4 border-white/20">
                {/* The Icon itself */}
                <MdOutlineMarkEmailRead className="text-white text-5xl transition-transform group-hover:scale-110 duration-300" />
              </div>
            </div>
            ...
            <form className="space-y-5">
              {/* Subject */}
              <div className="group">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-2 mb-2 block transition-colors group-focus-within:text-[#ffa41c]">Subject</label>
                <input
                  type="text"
              ...
              {/* Message */}
              <div className="group">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-2 mb-2 block transition-colors group-focus-within:text-[#ffa41c]">Your Message</label>
                <textarea
              ...
              {/* Contact Number */}
              <div className="group">
                <label className="text-xs font-bold text-gray-400 uppercase tracking-widest ml-2 mb-2 block transition-colors group-focus-within:text-[#ffa41c]">Phone Number</label>
                <input
                  type="tel"
              ...
              {/* Submit Button */}
              <button className="relative w-full group overflow-hidden bg-linear-to-r from-[#dc4900] to-[#ffa41c] py-4 rounded-2xl mt-6 transition-all active:scale-95 shadow-lg shadow-[#dc4900]/20">
